...
def fetch_variant_validator_data(genome_build, variant_description, select_transcripts):
    # Format the URL using the given text strings
    url = '/'.join(['http://rest.variantvalidator.org/variantvalidator', genome_build, variant_description, select_transcripts])
    # Fetch the data from the VariantValidator API
...
class VariantValidatorClass(Resource):
    def get(self, genome_build, variant_description, select_transcripts):
        return fetch_variant_validator_data(genome_build, variant_description, select_transcripts)
